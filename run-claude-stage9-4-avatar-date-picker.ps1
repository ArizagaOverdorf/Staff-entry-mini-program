...
$PromptPath = Join-Path $ProjectRoot "claude-stage9-4-avatar-date-picker-prompt.md"
...
Write-Host ""
Write-Host "Starting Claude Code for Stage 9.4 avatar persistence and date picker fixes in:" -ForegroundColor Cyan
