...
- `Codex-skills/self-review/references/report-template.md`
...
7. Always write one structured self-review report under `Codex-reports/`, even when verification passes.
