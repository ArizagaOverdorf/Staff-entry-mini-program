...
$PromptPath = Join-Path $ProjectRoot "claude-stage9-6-avatar-runtime-final-fix-prompt.md"
...
Write-Host ""
Write-Host "Starting Claude Code for Stage 9.6 avatar runtime final fix in:" -ForegroundColor Cyan
