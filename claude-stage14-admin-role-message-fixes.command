...
PROMPT_PATH="$PROJECT_ROOT/claude-stage14-admin-role-message-fixes-prompt.md"
...
echo ""
echo "Starting Claude Code for Stage 14 admin/role/message fixes in:"
echo "$PROJECT_ROOT"
echo ""
...
echo ""
echo "Claude Stage 14 task finished or was interrupted."
echo "Press any key to close this window."
read -k 1
