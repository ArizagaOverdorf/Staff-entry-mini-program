...
Assert-Contains ".\apps\miniapp\pages\credential\index.wxml" "新增一本技能证书" "Multi skill-certificate entry is missing"
Assert-Contains ".\apps\miniapp\pages\credential\index.wxml" "一人可上传多本证书" "Skill-certificate multi-upload copy is missing"
