...
$PromptPath = Join-Path $ProjectRoot "claude-stage14-admin-role-message-fixes-prompt.md"
...
Write-Host ""
Write-Host "Starting Claude Code for Stage 14 admin/role/message fixes in:"
...
Write-Host ""
Write-Host "Claude Stage 14 task finished or was interrupted."
Read-Host "Press Enter to close"
