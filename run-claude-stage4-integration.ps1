...
$PromptPath = Join-Path $ProjectRoot "claude-stage4-integration-prompt.md"
...
Write-Host ""
Write-Host "Starting Claude Code for Stage 4 local integration and admin usability in:" -ForegroundColor Cyan
Write-Host $ProjectRoot
Write-Host ""
Write-Host "File edits will be accepted automatically. Review command approvals carefully." -ForegroundColor Yellow
Write-Host "Approve .\verify-stage4.cmd, .\verify-stage3-5.cmd, .\seed-demo-staff.cmd, local build commands, and read-only git checks." -ForegroundColor Yellow
