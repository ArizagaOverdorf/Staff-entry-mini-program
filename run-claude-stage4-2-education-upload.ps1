...
$PromptPath = Join-Path $ProjectRoot "claude-stage4-2-education-upload-prompt.md"
...
Write-Host ""
Write-Host "Starting Claude Code for Stage 4.2 education/student-card upload in:" -ForegroundColor Cyan
Write-Host $ProjectRoot
Write-Host ""
Write-Host "File edits will be accepted automatically. Review command approvals carefully." -ForegroundColor Yellow
Write-Host "Approve .\verify-stage4-2.cmd, .\verify-stage4-1.cmd, local build commands, and read-only git checks." -ForegroundColor Yellow
