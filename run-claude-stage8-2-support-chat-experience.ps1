...
$PromptPath = Join-Path $ProjectRoot "claude-stage8-2-support-chat-experience-prompt.md"
...
Write-Host ""
Write-Host "Starting Claude Code for Stage 8.2 support chat experience in:" -ForegroundColor Cyan
...
Write-Host "Reject deletion, file moves, .env reads, npx prisma, git reset/checkout, Word document edits, WebSocket/external客服 integrations, or out-of-scope payment/order/distribution work." -ForegroundColor Yellow
Write-Host ""
