...
$PromptPath = Join-Path $ProjectRoot "claude-stage9-2-hardening-review-fixes-prompt.md"
...
Write-Host ""
Write-Host "Starting Claude Code for Stage 9.2 hardening review fixes in:" -ForegroundColor Cyan
