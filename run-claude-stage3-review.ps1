...
$PromptPath = Join-Path $ProjectRoot "claude-stage3-review-prompt.md"
...
Write-Host ""
Write-Host "Starting Claude Code for Stage 3 admin review workflow in:" -ForegroundColor Cyan
Write-Host $ProjectRoot
Write-Host ""
Write-Host "File edits will be accepted automatically. Review command approvals carefully." -ForegroundColor Yellow
Write-Host "Approve .\verify-stage3.cmd, local Prisma migrate commands, and read-only git checks." -ForegroundColor Yellow
