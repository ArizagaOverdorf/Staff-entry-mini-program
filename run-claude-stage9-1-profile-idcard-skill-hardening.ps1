...
$PromptPath = Join-Path $ProjectRoot "claude-stage9-1-profile-idcard-skill-hardening-prompt.md"
...
Write-Host ""
Write-Host "Starting Claude Code for Stage 9.1 profile, resident ID card, and skill credential hardening in:" -ForegroundColor Cyan
