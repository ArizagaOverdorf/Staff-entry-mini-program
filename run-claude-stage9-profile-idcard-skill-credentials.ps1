...
$PromptPath = Join-Path $ProjectRoot "claude-stage9-profile-idcard-skill-credentials-prompt.md"
...
Write-Host ""
Write-Host "Starting Claude Code for Stage 9 profile, resident ID card, and skill credentials in:" -ForegroundColor Cyan
