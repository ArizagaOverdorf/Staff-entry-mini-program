...
$PromptPath = Join-Path $ProjectRoot "claude-stage3-5-credential-rules-prompt.md"
...
Write-Host ""
Write-Host "Starting Claude Code for Stage 3.5 credential admission rules in:" -ForegroundColor Cyan
Write-Host $ProjectRoot
Write-Host ""
Write-Host "File edits will be accepted automatically. Review command approvals carefully." -ForegroundColor Yellow
Write-Host "Approve .\verify-stage3-5.cmd, local Prisma migrate commands, and read-only git checks." -ForegroundColor Yellow
