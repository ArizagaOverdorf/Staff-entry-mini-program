...
$PromptPath = Join-Path $ProjectRoot "claude-stage7-regression-fix-prompt.md"
...
Write-Host ""
Write-Host "Starting Claude Code for Stage 7 regression review and fixes in:" -ForegroundColor Cyan
...
Write-Host "Reject .env reads, npx prisma, Word document edits, deletes/moves, git reset/checkout, and out-of-scope ordering/payment/distribution work." -ForegroundColor Yellow
Write-Host ""
