...
PROMPT_PATH="$PROJECT_ROOT/claude-stage11-profile-credential-merge-prompt.md"
...
echo ""
echo "Starting Claude Code for Stage 11 profile and credential merge in:"
echo "$PROJECT_ROOT"
echo ""
...
echo ""
echo "Claude Stage 11 task finished or was interrupted."
echo "Press any key to close this window."
read -k 1
