...
$PromptPath = Join-Path $ProjectRoot "claude-stage4-1-review-skill-certs-prompt.md"
...
Write-Host ""
Write-Host "Starting Claude Code for Stage 4.1 review UX and multi skill certificates in:" -ForegroundColor Cyan
Write-Host $ProjectRoot
Write-Host ""
Write-Host "File edits will be accepted automatically. Review command approvals carefully." -ForegroundColor Yellow
Write-Host "Approve .\verify-stage4-1.cmd, .\verify-stage4.cmd, local Prisma migrate commands, and read-only git checks." -ForegroundColor Yellow
